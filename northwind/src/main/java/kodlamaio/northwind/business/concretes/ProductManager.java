...
public class ProductManager implements ProductService {
	...
	public DataResult<List<Product>> getAll() {
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(),"Products are listed successfully."); 
	...
	public DataResult<List<Product>> getByCategoryIdIn(List<Integer> categories) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByCategoryIn(categories),"Products are listed successfully.");
	}
	@Override
	...
	public DataResult<List<ProductWithCategoryDto>> getProductWithCategoryDetails() {
		...
		return new SuccessDataResult<List<ProductWithCategoryDto>>(this.productDao.getProductWithCategoryDetails(),"Products are listed successfully."); 
	}
